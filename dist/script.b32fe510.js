...
base('Filters').select({
  ...
  records.forEach(function (record) {
    ...
    var $card = "<li><input type='checkbox' id=" + filter + " class='filterCheckbox' /> " + recordText + "</li>";
...
base('Filters').select({
  ...
  records.forEach(function (record) {
    ...
    var $card = "<li><input type='checkbox' id=" + filter + " class='filterCheckbox' /> " + renameFilters(recordText) + "</li>";
