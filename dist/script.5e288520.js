...
function e(e){return o(e)||n(e)||r(e)||t()}function t(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function r(e,t){if(e){if("string"==typeof e)return c(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?c(e,t):void 0}}function n(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function o(e){if(Array.isArray(e))return c(e)}function c(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,i=new Array(t);r<t;r++)i[r]=e[r];return i}var l=require("airtable"),s=new l({apiKey:"keyYJ7zM4UWu6RYdT"}).base("appAzdZwdzJzHt494"),a=[],p=function(t,r){a=[].concat(e(a),e(t)),r()},u=function(e){e?console.error(e):a.forEach(function(e){console.log("Retrieved ",e.get("Name")),freqs=e.get("Frequency").join(", "),geos=e.get("Geography").join(", "),link=e.get("Link"),text=e.get("Description"),subtopics=e.get("Subtopics").join(", "),geofilters=d(geos);var t=$("<div/>",{class:"card mb-3 "+freqs+" "+geofilters});t.append("<div class='card-header'>"+e.get("Survey").link(link)+"&nbsp;</div>");var r=$("<div/>",{class:"card-body"}),i=$("<ul/>",{class:"list-group list-group-flush"});r.append($("<p class='card-text'>").text(e.get("Description"))),t.append(r),t.append(i),i.append("<li class='list-group-item'><b>Frequencies: </b>"+freqs+"&nbsp;</li>"),i.append("<li class='list-group-item'><b>Geographies: </b>"+geos+"&nbsp;</li>"),i.append("<li class='list-group-item'><b>Subtopics: </b>"+subtopics+"&nbsp;</li>"),$("#cards").append(t)})};function d(e){return geofilters=e.replace("Block Group","BlockGroup"),geofilters=geofilters.replace("Economic Place","Economic"),geofilters=geofilters.replace("Metro Area","Metro"),geofilters=geofilters.replace("Other","OtherGeo"),geofilters=geofilters.replace(/,/g,""),geofilters}function g(){document.getElementById("cards").classList.toggle("card-columns")}s("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics"]}).eachPage(p,u),document.getElementById("viewChange").onclick=g;var f="";function y(){$("input[type='checkbox']:checked").prop("checked",!1),f="",m()}function b(e,t){for(i=0;i<t.length;i++){t[i].style.display="inline-block",t[i].textContent.toLowerCase().includes(e)||(t[i].style.display="none")}}function m(){var e=document.getElementById("quicksearch");inputVal=e.value,inputVal=inputVal.toLowerCase().trim(),f?($(".card").hide(),b(inputVal,$(f))):b(inputVal,$(".card"))}document.getElementById("uncheckAll").onclick=y,$("#filterCards input").change(function(){f=$(this).is(":checked")?f+"."+this.id:f.replace("."+this.id,""),m()}),document.getElementById("quicksearch").onkeyup=m;
},{"airtable":"gskY"}]},{},["nq4D"], null)
//# sourceMappingURL=script.5e288520.js.map