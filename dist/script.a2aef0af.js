...
function e(e){return o(e)||n(e)||r(e)||t()}function t(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function r(e,t){if(e){if("string"==typeof e)return c(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?c(e,t):void 0}}function n(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function o(e){if(Array.isArray(e))return c(e)}function c(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,i=new Array(t);r<t;r++)i[r]=e[r];return i}var s=require("airtable"),l="",a=new s({apiKey:"keyYJ7zM4UWu6RYdT"}).base("appAzdZwdzJzHt494"),p=[],u=function(t,r){p=[].concat(e(p),e(t)),r()},d=function(e){e?console.error(e):p.forEach(function(e){console.log("Retrieved ",e.get("Name")),freqs=e.get("Frequency").join(", "),freqfilters=e.get("Frequency").join(" "),geos=e.get("Geography").join(", "),link=e.get("Link"),text=e.get("Description"),subtopics=e.get("Subtopics").join(", "),subtopicfilters=e.get("Subtopics").join(" "),geofilters=g(geos);var t=$("<div/>",{class:"card mb-3 "+freqfilters+" "+geofilters+" "+subtopicfilters}),r=$("<div/>",{class:"card-body"}),i=$("<ul/>",{class:"list-group list-group-flush"});r.append("<h5 class='card-title'>"+e.get("Survey").link(link)+"&nbsp;</h5>"),r.append($("<p class='card-text'>").text(e.get("Description"))),t.append(r),t.append(i),i.append("<li class='list-group-item'><b>Frequencies: </b>"+freqs+"&nbsp;</li>"),i.append("<li class='list-group-item'><b>Geographies: </b>"+geos+"&nbsp;</li>"),i.append("<li class='list-group-item'><b>Subtopics: </b>"+subtopics+"&nbsp;</li>"),$("#cards").append(t)})};function g(e){return geofilters=e.replace("Block Group","BlockGroup"),geofilters=geofilters.replace("Economic Place","Economic"),geofilters=geofilters.replace("Metro Area","Metro"),geofilters=geofilters.replace("Other","OtherGeo"),geofilters=geofilters.replace(/,/g,""),geofilters}function f(){document.getElementById("cards").classList.toggle("card-columns")}function y(){$("input[type='checkbox']:checked").prop("checked",!1),l="",m()}function b(e,t){for(i=0;i<t.length;i++){t[i].style.display="inline-block",t[i].textContent.toLowerCase().includes(e)||(t[i].style.display="none")}}function m(){var e=document.getElementById("quicksearch");inputVal=e.value,inputVal=inputVal.toLowerCase().trim(),l?($(".card").hide(),b(inputVal,$(l))):b(inputVal,$(".card"))}a("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics"]}).eachPage(u,d),document.getElementById("viewChange").onclick=f,document.getElementById("uncheckAll").onclick=y,$("#filterCards input").change(function(){l=$(this).is(":checked")?l+"."+this.id:l.replace("."+this.id,""),m()}),document.getElementById("quicksearch").onkeyup=m;
},{"airtable":"gskY"}]},{},["nq4D"], null)
//# sourceMappingURL=script.a2aef0af.js.map