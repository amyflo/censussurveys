...
function e(e){return o(e)||i(e)||t(e)||r()}function r(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function t(e,r){if(e){if("string"==typeof e)return c(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);return"Object"===t&&e.constructor&&(t=e.constructor.name),"Map"===t||"Set"===t?Array.from(e):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?c(e,r):void 0}}function i(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function o(e){if(Array.isArray(e))return c(e)}function c(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,i=new Array(r);t<r;t++)i[t]=e[t];return i}var s=require("airtable"),n=new s({apiKey:"keyWfSmHAolRQJxTk"}).base("appAzdZwdzJzHt494"),p=[],l=function(r,t){p=[].concat(e(p),e(r)),t()},a=function(e){function r(e,r){recordText=r.get(e);var t=recordText.join(", "),i=recordText.map(function(e){return e.replace(/\s/g,"")}).join(" ");return[u(t),i.toLowerCase()]}e?console.error(e):p.forEach(function(e){title=e.get("Survey"),link=e.get("Link"),text=e.get("Description"),frequencies=r("Frequency",e),geos=r("Geography",e),topics=r("Topic",e),subtopics=r("Subtopics",e);var t=$("<div/>",{class:"card mb-3 "+frequencies[1]+" "+geos[1]+" "+subtopics[1]+" "+topics[1]+" "}),i=$("<div/>",{class:"card-body"}),o=$("<ul/>",{class:"list-group list-group-flush"});i.append("<h5 class='card-title'>"+(title+" →").link(link)+"</h5>"),i.append("<p class='card-text'>"+text+"</p>"),t.append(i),t.append(o),o.append("<li class='list-group-item'><b>Frequencies: </b>"+frequencies[0]+"&nbsp;</li>"),o.append("<li class='list-group-item'><b>Geographies: </b>"+geos[0]+"&nbsp;</li>"),o.append("<li class='list-group-item'><b>Topics: </b>"+topics[0]+"&nbsp;</li>"),o.append("<li class='list-group-item'><b>Subtopics: </b>"+subtopics[0]+"&nbsp;</li>"),$("#cards").append(t)})};function u(e){return e=(e=e.replace("Other Geos","Other")).replace("Other Freqs","Other")}n("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics","Topic"]}).eachPage(l,a),n("Filters").select({view:"Topics",fields:["Filter","Type","Publish?"]}).eachPage(function(e,r){e.forEach(function(e){recordText=e.get("Filter"),recordType=e.get("Type"),publish=e.get("Publish?");var r="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").toLowerCase()+" class='filterCheckbox' /> "+recordText+"</li>";"Yes"==publish&&("Subtopics"==recordType&&$("#subtopicsFilters").append(r),"Topics"==recordType&&$("#topicFilters").append(r))}),r()},function(e){e&&console.error(e)}),n("Filters").select({view:"Geos & Freqs",fields:["Filter","Type","Publish?"]}).eachPage(function(e,r){e.forEach(function(e){recordText=e.get("Filter"),recordType=e.get("Type"),publish=e.get("Publish?");var r="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").toLowerCase()+" class='filterCheckbox' /> "+u(recordText)+"</li>";"Yes"==publish&&("Geographies"==recordType&&$("#geographyFilters").append(r),"Frequencies"==recordType&&$("#frequencyFilters").append(r))}),r()},function(e){e&&console.error(e)});
},{"airtable":"gskY"}]},{},["nq4D"], null)
//# sourceMappingURL=script.d5c811b5.js.map