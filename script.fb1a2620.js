...
function e(e){return o(e)||r(e)||n(e)||t()}function t(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function n(e,t){if(e){if("string"==typeof e)return c(e,t);var i=Object.prototype.toString.call(e).slice(8,-1);return"Object"===i&&e.constructor&&(i=e.constructor.name),"Map"===i||"Set"===i?Array.from(e):"Arguments"===i||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)?c(e,t):void 0}}function r(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function o(e){if(Array.isArray(e))return c(e)}function c(e,t){(null==t||t>e.length)&&(t=e.length);for(var i=0,n=new Array(t);i<t;i++)n[i]=e[i];return n}var l=require("airtable"),s="",a=new l({apiKey:"keyYJ7zM4UWu6RYdT"}).base("appAzdZwdzJzHt494"),p=[],u=function(t,i){p=[].concat(e(p),e(t)),i()},d=function(e){e?console.error(e):p.forEach(function(e){console.log("Retrieved ",e.get("Name")),freqs=e.get("Frequency").join(", "),freqfilters=e.get("Frequency").join(" "),geos=e.get("Geography").join(", "),link=e.get("Link"),text=e.get("Description"),subtopics=e.get("Subtopics").join(", "),subtopicfilters=e.get("Subtopics").join(" "),geofilters=g(geos);var t=$("<div/>",{class:"card mb-3 "+freqfilters+" "+geofilters+" "+subtopicfilters}),i=$("<div/>",{class:"card-body"}),n=$("<ul/>",{class:"list-group list-group-flush"});i.append("<h5 class='card-title'>"+e.get("Survey").link(link)+"&nbsp;</h5>"),i.append($("<p class='card-text'>").text(e.get("Description"))),t.append(i),t.append(n),n.append("<li class='list-group-item'><b>Frequencies: </b>"+freqs+"&nbsp;</li>"),n.append("<li class='list-group-item'><b>Geographies: </b>"+geos+"&nbsp;</li>"),n.append("<li class='list-group-item'><b>Subtopics: </b>"+subtopics+"&nbsp;</li>"),$("#cards").append(t)})};function g(e){return geofilters=e.replace("Block Group","BlockGroup"),geofilters=geofilters.replace("Economic Place","Economic"),geofilters=geofilters.replace("Metro Area","Metro"),geofilters=geofilters.replace("Other","OtherGeo"),geofilters=geofilters.replace(/,/g,""),geofilters}function f(){document.getElementById("cards").classList.toggle("card-columns")}function y(){$("input[type='checkbox']:checked").prop("checked",!1),s="",b()}function m(e,t){for(i=0;i<t.length;i++){t[i].style.display="inline-block",t[i].textContent.toLowerCase().includes(e)||(t[i].style.display="none")}}function b(){var e=document.getElementById("quicksearch");inputVal=e.value,inputVal=inputVal.toLowerCase().trim(),s?($(".card").hide(),m(inputVal,$(s))):m(inputVal,$(".card"))}function h(e,t){for(li=e.getElementsByTagName("li"),s=t.value.toUpperCase(),i=0;i<li.length;i++)checkbox=li[i].innerHTML.replace(/<.*>/,""),checkbox.toUpperCase().indexOf(s)>-1?li[i].style.display="":li[i].style.display="none"}function k(){input=document.getElementById("topicsInput"),ul=document.getElementById("topics"),h(ul,input)}a("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics"]}).eachPage(u,d),document.getElementById("viewChange").onclick=f,document.getElementById("uncheckAll").onclick=y,$("#filterCards input").change(function(){s=$(this).is(":checked")?s+"."+this.id:s.replace("."+this.id,""),b()}),document.getElementById("quicksearch").onkeyup=b,document.getElementById("topicsInput").onkeyup=k;
},{"airtable":"gskY"}]},{},["nq4D"], null)
//# sourceMappingURL=script.fb1a2620.js.map